...
void regionQuery(int* neighbours,int &k, unsigned char* R, unsigned char* G,unsigned  char* B,int n0,int n, int rows, int cols,unsigned short *label,bool *label0, int E)
{
     //double E = 10*10;   
     int x=n/cols+1;
     int y=n%cols+1;
